...
const treeServices = [
    { label: 'Addiction', x: 28, y: 36 },
    { label: 'Relationships', x: 42, y: 28 },
    { label: 'Stress', x: 58, y: 25 },
    { label: 'Anxiety', x: 72, y: 34 },
    { label: 'Bereavement', x: 34, y: 52 },
    { label: 'Depression', x: 66, y: 50 },
    { label: 'LGBTQ+', x: 25, y: 68 },
    { label: 'Neurodiversity', x: 50, y: 66 },
    { label: 'Stress Mgmt', x: 75, y: 68 },
]
...
function ServicesTree() {
    ...
    return (
        <section
            ref={sectionRef}
            className={`services-tree-section ${hasAnimated ? 'is-visible' : ''}`}
        >
            ...
            <div className="tree-wrapper">
                ...
                >
                    ...
                    <path
                        className="tree-line trunk"
                        d="M50 95 C49 78, 51 65, 50 48"
                    />

                    <path
                        className="tree-line branch branch-1"
                        d="M50 60 C38 55, 30 47, 25 34"
                    />
                    <path
                        className="tree-line branch branch-2"
                        d="M50 55 C43 44, 42 35, 40 25"
                    />
                    <path
                        className="tree-line branch branch-3"
                        d="M50 50 C58 39, 62 32, 60 22"
                    />
                    <path
                        className="tree-line branch branch-4"
                        d="M50 60 C62 55, 72 47, 78 34"
                    />
                    <path
                        className="tree-line branch branch-5"
                        d="M50 72 C38 67, 30 63, 22 58"
                    />
                    <path
                        className="tree-line branch branch-6"
                        d="M50 72 C64 68, 72 63, 80 58"
                    />
                    <path
                        className="tree-line root"
                        d="M50 94 C46 95, 42 97, 38 99"
                    />
                    <path
                        className="tree-line root"
                        d="M50 95 C50 97, 50 98, 50 100"
                    />
                    <path
                        className="tree-line root"
                        d="M50 94 C54 95, 58 97, 62 99"
                    />
                </svg>
            ...
            <Link to="/services" className="tree-view-all-button">
                View All Services →
            </Link>
        </section>
    )
